...
public class MainActivity extends ActionBarActivity {
    ...
    private void makeQuestions() {
        ...
        Question q4 = new Question(R.drawable.touhou4,"東方紅魔郷３面ボス・紅 美鈴の（音楽）テーマは？","明治１７年の上海アリス","明治１６年の上海アリス","明治１８年の上海アリス");
...
//　　　　 Question q10 = new Question(R.drawable.touhou10,"幻想万華鏡の","","","");
